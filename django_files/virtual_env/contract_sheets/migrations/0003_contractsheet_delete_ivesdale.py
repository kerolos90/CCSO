# Generated by Django 4.1.1 on 2023-04-10 21:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('contract_sheets', '0002_remove_ivesdale_total_timespent_ivesdale_carnumber_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.CharField(choices=[('Deputy Gabra #503', 'Deputy Gabra #503'), ('Deputy Plotner #539', 'Deputy Plotner #539'), ('Sergeant Herrig #541', 'Sergeant Herrig #541')], max_length=30)),
